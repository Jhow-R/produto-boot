			...
			<div class="col-lg-12">
				<div class="well">
					...
					<form:form modelAttribute="produtoModel"
						action="${contextPath}/produto/${produtoModel.id}" method="put">
						...
						<div class="form-group">
							...
							<form:input type="text" path="sku" id="sku" class="form-control"
						...
						<div class="form-group">
							...
							<form:select path="categoria.idCategoria" class="form-control">
								<form:options items="${categorias}" itemLabel="nomeCategoria"
						...
						<div class="form-group">
							...
							<form:textarea id="descricao" class="form-control"
						...
						<div class="form-group">
							...
							<form:input type="number" step="0.01" path="preco" id="preco"
						...
						<div class="form-group">
							...
							<form:textarea id="mensagem" class="form-control"
								path="caracteristicas" rows="4" cols="100" />
