			...
			<div class="col-lg-12">
				<div class="well">
					...
					<div class="form-group">
						<label class="control-label" for="nome">Nome:</label> <b>${produto.nome}</b>
					</div>

					<div class="form-group">
						<label class="control-label" for="nome">Categoria:</label> <label
							class="label label-default">${produto.categoria.nomeCategoria}</label>
					</div>

					<div class="form-group">
						<label class="control-label" for="nome">Marca:</label> <label
							class="label label-default">${produto.marca.nomeMarca}</label>
					</div>

					<div class="form-group">
						<label class="control-label" for="nome">SKU:</label> <label
							class="label label-default">${produto.sku}</label>
					</div>

					<div class="form-group">
						<label class="control-label" for="lojas">Lojas:</label> 
						<c:forEach items="${produto.lojas}" var="loja">
							<label class="label label-default">${loja.nome}</label>
						</c:forEach>
					</div>

					<div class="form-group">
						<label class="control-label" for="mesnagem">Descrição:</label> <label
							class="label label-default">${produto.descricao}</label>
					</div>
